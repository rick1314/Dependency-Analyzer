...
namespace CodeAnalysis
{
  ...
  public class SaveDeclar : AAction
  {
    ...
    ///////////////////////////////////////////////////////////////////
    // rule to dectect inheritance in class definitions

    public class DetectIN : ARule
    {
        public override bool test(ITokenCollection semi)
        {
...
//                    local.add(semi[index]).add(semi[indexST - 1]);
  ...
  public class BuildCodeAnalyzer
  {
    ...
    ///////////////////////////////////////////////////////////////////
    // NameCodeAnalyzer class
    ///////////////////////////////////////////////////////////////////

    public class NameCodeAnalyzer
    {
        Repository repo = new Repository();

        public NameCodeAnalyzer(Lexer.ITokenCollection semi)
        {
            repo.semi = semi;
        }
        public virtual Parser build()
